...
<template>
    <ul class="header__top bg-[#303030] flex items-center justify-end gap-6 pr-12 py-2">
        <HeaderTopItem title="Tra cứu đơn hàng" icon="ph:package-bold" :to-view-name="auth.$state.data.user ? 'Order List' : 'Login'" />
        <HeaderTopItem title="Tìm cửa hàng" icon="ph:map-pin-bold" to-view-name="" />
        <HeaderTopItem title="Yêu thích" icon="ph:heart-bold" :to-view-name="auth.$state.data.user ? 'Wishlist' : 'Login'" />
