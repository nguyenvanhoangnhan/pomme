    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shoesshop.product')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shoe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shoesshop.shoe')),
            ],
        ),
        migrations.CreateModel(
            name='OrderProduct',
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shoesshop.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shoesshop.product')),
            ],
        ),
        migrations.CreateModel(
